    ...
    <footer className={styles.footer}>
      <div className={styles.inner}>
        ...
        <div className={styles.right}>
          <a className={styles.iconLink} href="https://github.com/0x3639/pfscan" rel="noreferrer noopener" target="_blank">
            <GithubMark />
            GitHub
          </a>
          <span className={styles.dot}>·</span>
          <span className={styles.credit}>
            Made with <Heart className={styles.heart} size={13} aria-hidden="true" /> by{" "}
            <a href="https://github.com/0x3639" rel="noreferrer noopener" target="_blank">0x3639</a>
          </span>
        </div>
      </div>
    </footer>
